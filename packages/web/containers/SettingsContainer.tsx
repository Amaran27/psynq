...
const TelephonySettings = () => {
    return (
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-3xl">
            ...
            <p className="text-slate-500 mb-8 font-medium text-lg">Configure your active Asterisk bridge.</p>
            
            <div className="bg-white p-10 rounded-2xl shadow-sm border border-slate-200">
                <div className="mb-10 p-6 bg-blue-50 border border-blue-100 rounded-xl flex items-center space-x-4">
                    <span className="text-3xl">⚡</span>
                    <div>
                        <h4 className="font-bold text-blue-900">Asterisk Engine Active</h4>
                        <p className="text-sm text-blue-700">All calls are routed through your local ARI bridge.</p>
                    </div>
                </div>
