...
export class FinalSchemaUpdate1766215009160 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_c36442ce091cc70ede7e2a8669" ON "settings" ("organizationId", "key") `);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX "public"."IDX_c36442ce091cc70ede7e2a8669"`);
